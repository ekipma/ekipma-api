...
var file_protos_user_proto_rawDesc = []byte{
	...
	0x06, 0x6d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x22, 0x4d, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x4f,
	...
	0x69, 0x6e, 0x10, 0x03, 0x32, 0x8e, 0x03, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	...
	0x74, 0x70, 0x75, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x4b, 0x0a, 0x0c, 0x52, 0x65, 0x6d, 0x6f,
	...
	0x69, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x42, 0x6f, 0x6f, 0x6c, 0x4f, 0x75, 0x74,
	0x70, 0x75, 0x74, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x67, 0x6f, 0x3b, 0x70, 0x62,
...
var file_protos_user_proto_goTypes = []interface{}{
	...
	(*IdInput)(nil),               // 9: ekipma.api.common.IdInput
	(*BoolOutput)(nil),            // 10: ekipma.api.common.BoolOutput
}
var file_protos_user_proto_depIdxs = []int32{
	...
	4,  // 6: ekipma.api.user.UserService.AddFriends:input_type -> ekipma.api.user.FriendInput
	8,  // 7: ekipma.api.user.UserService.GetFriends:input_type -> ekipma.api.common.Empty
	9,  // 8: ekipma.api.user.UserService.RemoveFriend:input_type -> ekipma.api.common.IdInput
	5,  // 9: ekipma.api.user.UserService.RegisterUser:output_type -> ekipma.api.user.UserOutput
	5,  // 10: ekipma.api.user.UserService.LoginUser:output_type -> ekipma.api.user.UserOutput
	6,  // 11: ekipma.api.user.UserService.AddFriends:output_type -> ekipma.api.user.FriendOutput
	6,  // 12: ekipma.api.user.UserService.GetFriends:output_type -> ekipma.api.user.FriendOutput
	10, // 13: ekipma.api.user.UserService.RemoveFriend:output_type -> ekipma.api.common.BoolOutput
